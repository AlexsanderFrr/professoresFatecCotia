                                    ...
                                    <%
                                        try {
                                            ...
                                            while (rs.next()) {
                                                ...
                                                out.print("<td><a href='editarExcluir/ediCursoCoordenador.jsp?funcao=excluir&id=" + rs.getString(1) + "'><button class='btn btn-danger'><i class='bi bi-x-lg'></i> Excluir</button></a></td></tr>");
                                            }
                                        } catch (Exception e) {
                                            out.println(e);
                                        }
