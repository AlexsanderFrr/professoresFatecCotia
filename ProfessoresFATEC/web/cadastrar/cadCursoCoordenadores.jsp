...
<html>
    <head>
        ...
        <title>Cadastro Cursos dos Cooordenadores</title>
                ...
                <div class="col">
                    ...
                    <div class="card border-secondary mb-3">
                        <div class="card-header"> 
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-md-6" style="text-align:left">Cadastrar Curso dos Coodernadores</div>

                                <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
                                    <form class="form-inline text-center" method="post" action="">

                                        <div class="input-group mb-3">
                                            <select type="text" class="form-select" name="txtBuscaCursoCoordenador" aria-label="Recipient's username" aria-describedby="button-addon2" required>
                                            ...
                                            <button class="btn btn-outline-secondary" type="submit" name="btnBuscaCursoCoodernador" id="button-addon2"><i class="bi bi-search"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<!--                                        select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="txtNomeInstituicao">
                                        ...
                                        <button type="submit" name="btnCadCursoCoordenador" class="btn btn-success"><i class="bi bi-clipboard2-fill"></i> Cadastrar</button>
                                    ...
                                    <%
                                        ...
                                        if (request.getParameter("btnCadCursoCoordenador") != null) {
                                            try {

                                                st.executeUpdate("insert into tbcursocoordenador(codCoordenador, codCurso) values('" + codCoordenador + "', '" + codCurso + "')");

                                                out.println("<meta http-equiv='refresh' content='0;URL='../index.jsp'>");
                                                out.println("<script type=\"text/javascript\">");
                                                out.println("alert('Cadastro de CURSO COORDENADOR realizado com sucesso');");
                                                out.println("</script>");
                                            } catch (Exception e) {
